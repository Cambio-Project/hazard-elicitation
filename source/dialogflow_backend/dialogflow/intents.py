...
INTENT_HANDLERS = {
    ...
    TEXT[INTENT_ELICITATION_RESPONSE_MEASURE_NAME]:                   elicitation_response_measure_handler,
    TEXT[INTENT_ELICITATION_RESPONSE_MEASURE_NORMAL_NAME]:            elicitation_response_measure_normal_handler,
    TEXT[INTENT_ELICITATION_RESPONSE_MEASURE_NORMAL_FOLLOWUP_NAME]:   elicitation_response_measure_normal_followup_handler,
    TEXT[INTENT_ELICITATION_RESPONSE_MEASURE_CASES_NAME]:             elicitation_response_measure_cases_handler,
    TEXT[INTENT_ELICITATION_RESPONSE_MEASURE_CASES_FOLLOWUP_NAME]:    elicitation_response_measure_cases_followup_handler,
    TEXT[INTENT_ELICITATION_RESPONSE_MEASURE_RECOVERY_NAME]:          elicitation_response_measure_recovery_handler,
    TEXT[INTENT_ELICITATION_RESPONSE_MEASURE_RECOVERY_FOLLOWUP_NAME]: elicitation_response_measure_recovery_followup_handler,
