...
INTENT_ELICITATION_RESPONSE_MEASURE_NAME = text_id()
INTENT_ELICITATION_RESPONSE_MEASURE_TEXT = text_id()
INTENT_ELICITATION_RESPONSE_MEASURE_NORMAL_NAME = text_id()
INTENT_ELICITATION_RESPONSE_MEASURE_NORMAL_TEXT = text_id()
INTENT_ELICITATION_RESPONSE_MEASURE_NORMAL_FOLLOWUP_NAME = text_id()
INTENT_ELICITATION_RESPONSE_MEASURE_CASES_NAME = text_id()
INTENT_ELICITATION_RESPONSE_MEASURE_CASES_TEXT = text_id()
INTENT_ELICITATION_RESPONSE_MEASURE_CASES_FOLLOWUP_NAME = text_id()
INTENT_ELICITATION_RESPONSE_MEASURE_RECOVERY_NAME = text_id()
INTENT_ELICITATION_RESPONSE_MEASURE_RECOVERY_TEXT = text_id()
INTENT_ELICITATION_RESPONSE_MEASURE_RECOVERY_FOLLOWUP_NAME = text_id()
