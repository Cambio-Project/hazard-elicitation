...
INTENT_ELICITATION_RESPONSE_MEASURE_NORMAL_TIME_TEXT = text_id()
INTENT_ELICITATION_RESPONSE_MEASURE_NORMAL_CASES_TEXT = text_id()
INTENT_ELICITATION_RESPONSE_MEASURE_RECOVERY_TIME_TEXT = text_id()
INTENT_ELICITATION_RESPONSE_MEASURE_FOLLOWUP_TIMES_NAME = text_id()
INTENT_ELICITATION_RESPONSE_MEASURE_FOLLOWUP_CASES_NAME = text_id()
