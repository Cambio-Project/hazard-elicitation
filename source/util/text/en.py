...
TEXT = {
    ...
    STIMULUS_RESPONSE_TEXTS:                                 {
        'Service':   {
            ...
            'response-measures': {
                'normal-time':   ['10s', '5s', '3s', '1s', '500s', '300ms', '100ms', '50ms', '30ms', '10ms', '<10ms'],
    ...
    INTENT_ELICITATION_RESPONSE_MEASURE_NORMAL_TIME_TEXT:    'What would be an optimal response time?',
    INTENT_ELICITATION_RESPONSE_MEASURE_NORMAL_CASES_TEXT:   'In how many cases should this hold?',
    INTENT_ELICITATION_RESPONSE_MEASURE_RECOVERY_TIME_TEXT:  'How long is a <b>non-optimal</b> metric tolerable?',
    INTENT_ELICITATION_RESPONSE_MEASURE_FOLLOWUP_TIMES_NAME: 'Elicitation-Specify-Response-Measure-Followup-Times',
    INTENT_ELICITATION_RESPONSE_MEASURE_FOLLOWUP_CASES_NAME: 'Elicitation-Specify-Response-Measure-Followup-Cases',
    ...
    INTENT_ELICITATION_SAVE_SCENARIO_MODIFY_OPTIONS:         {
        'e-select-component':         'Modify the component',
